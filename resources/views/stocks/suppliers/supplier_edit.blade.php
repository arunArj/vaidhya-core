                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="pin" value="{{$supplier->pin}}" class="form-control" name="pin">
                        @error('pin')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="address" value="{{$supplier->address}}" class="form-control" id="address" >
                        @error('address')
                          <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$supplier->district}}" name="district" id="district">
                        @error('district')
                          <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="contact_name" value="{{$supplier->contact_name}}" class="form-control" id="contact_name" >
                    @error('contact_name')
                      <small class="text-danger">{{ $message }}</small>
                    @enderror
                  </div>
